...
are 5\% of the record and are shown for shape, not for scale; Figures~\ref{fig:survey}
to~\ref{fig:calibration} carry the population-level evidence.}
\label{fig:crossover}
\end{figure*}
...
sealed direction cohorts, by the size of the effect they were asked to call. Almost every
miss sits left of the one-point guard: above it the rule is correct on 21 of 22, below it on
11 of 18, which is a coin flip. The guard's \emph{existence} is what this measures; its
value is a round number fixed in a protocol, and every floor from 0.25 to 5.00 separates.}
