...
gate applied, the audit returns a direction on 29 of 52 stored sweeps --- \textbf{a little under
six times in ten} --- and hands back the rest as unanswerable rather than scoring them. Two scope limits belong here: the relationship disappears under
...
\textbf{Two rates, and they are not the same rate.} The survey's 78\% and the audit's 29 of 52
...
The 29 of 52 applies \emph{every} gate the algorithm states to the stored sweeps, which are a
...
share at 66--89\%, and leaving each population out in turn never moves it below 77\%. Run over
the 52 stored sweeps that resolve to a dataset spec, the audit returns 29 directional
verdicts, 8 \textsc{non-monotone}, 13 \textsc{void}, one refusal at the noise floor and one
bracket with no natural arm --- so it gives a direction a little under six times in ten, tells
a team the question is moot or the rule inapplicable in most of the remainder, and is silent
on four of 52. Every one of the 29 matches what the fitted constraint did at that population's
