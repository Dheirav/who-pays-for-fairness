...
\textbf{Data.} 161 independent populations across eight sources. Two are US surveys: UCI Adult
...
--- the \textbf{86 natural arms across 70 populations} that clear both of the audit's gates
and on which the plain constraint withdraws. It costs \textbf{0.05 accuracy points} on
average, moves the median exchange rate from 1.33 destroyed per created to 0.94, and brings
\textbf{70 of the 86} below one-for-one, none of which were below it already. On the median
arm it does not merely soften the withdrawal but reverses it, from $-2.94\%$ to $+0.98\%$.

Three things that should be said with those numbers rather than after them. The count is over
arms and the populations are 70, so the ratio is not 86 independent trials. Sub-1.0 is a
...
\begin{table}[!t]
\caption{What the selection-rate floor buys, on the 86 natural arms over 70 populations that
...
Arms at or below one-for-one & 0 of 86 & \textbf{70 of 86} \\
Change in the pool & $-2.94\%$ & $\mathbf{+0.98\%}$ \\
