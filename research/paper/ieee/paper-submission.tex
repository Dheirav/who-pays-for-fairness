...
consistent, backed by a twenty-seed replication --- and it is the clause that lost: the
unrefined rule scores 7 of 8 on the same arms, missing only the population sitting at the
boundary. The clause was route-specific: its own arms reach a low rate by thresholding one fixed score
