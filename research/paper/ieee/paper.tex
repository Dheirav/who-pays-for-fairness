...
current model says yes, read against that population's crossover. Across 55 independent
...
\textbf{Data.} Fifty-five independent populations across seven data sources: UCI Adult
(45{,}222 rows); ACS Income \cite{ding2021} across forty US states, eight further
state-years (2014 and 2022) and two protected attributes; HMDA mortgage records for two states, by race and sex and split by loan purpose;
...
high, a shape absent from every earlier vintage. Two 2019 diagnostics acquit the one
pipeline suspect (the survey's recoded relationship column: 2019 carries it and behaves
classically, Ohio's 2019 crossover sitting between its 2018 value and its 2022 inversion),
so the change lives in the 2019--2022 world itself and its mechanism is unidentified. Until
it is, no claim here should be applied to 2020s-vintage data.
