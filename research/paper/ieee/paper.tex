...
six times in ten} --- and hands back the rest as unanswerable rather than scoring them.
...
apply''. The 29 of 52 applies \emph{every} gate the algorithm states --- the noise floor, the
