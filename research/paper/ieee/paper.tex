...
does not transfer across populations and no pooled slope exists; below a selection rate of
about 0.10 the two routes to the rate disagree, and only the label route carries the claim
there; and in the attribute-aware regime the direction is determined by theorem, the rate
predicts nothing, and there is nothing left to predict.
...
\textbf{The two manipulations diverge at low selection rates.} The operating-point route and
the label route disagree completely below a rate of about 0.10, and the accuracy rule does not
separate them. We claim the relationship across the transition only.
