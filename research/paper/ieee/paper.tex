...
The registered deconfounding cohort (Brazil and Mexico censuses) has since run and
returned \textsc{underpowered} as pre-registered --- Brazil's conditional sex gaps sit
below the audit's own disparity floor and its gates refused them --- so the confound
stands, honestly unresolved. On a second,
...
therefore \emph{open}, not resolved, and one positive is banked: Mexico 2015 brackets
a crossover at 0.423--0.483, the first located outside the United States, below the US
survey cluster. The prediction used
...
included and uncorrected. The rows should not be read as fifteen attempts at one claim, of
...
the label-rarity confound stands open; Mexico 2015 brackets the first non-US
crossover, 0.423--0.483 \\
\bottomrule
\end{tabular}
\end{table}
