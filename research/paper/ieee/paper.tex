...
the record and are drawn for shape, not scale; Figures~\ref{fig:survey}
...
is \emph{shape}. Five of the 21 samples sit more than 0.20 from their crossover and would
have reached the same decision from one fit; that 24\% over-states the waste, because every
...
\textbf{Two rates, and they are not the same rate.} The survey's 78\% and the audit's
29-of-52 are different measurements and a reader is entitled to be confused by them meeting on
...
included and uncorrected. Counted once and consistently, the table holds \textbf{twenty-two} rows: fifteen fail, three record a hold (one of them alongside a failed first stage), two returned underpowered, and one
settled a reading rather than a pass or a fail. Of the \emph{twelve} that test a \emph{direction} rule on populations it had not seen, one
...
whole ledger of twenty-two, fifteen fail, three hold, two returned underpowered, and one --- the
regime-deconfounding test, whose pre-committed two-reading design returned the method reading
--- is an outcome rather than a pass or a fail of ours. Earlier drafts of this paper described
